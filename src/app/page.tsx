      ...
      <div className="bento-bg-deco" aria-hidden="true">
        ...
        <svg className="bento-bg-svg" viewBox="0 0 1600 1000" preserveAspectRatio="xMidYMid slice">
          ...
          <g transform="translate(800, 500)" opacity=".55">
            ...
            <line className="bg-tick-minor" x1="-30" y1="-30" x2="-12" y2="-12"/>
            <line className="bg-tick-minor" x1="12" y1="-12" x2="30" y2="-30"/>
            <line className="bg-tick-minor" x1="-30" y1="30" x2="-12" y2="12"/>
            <line className="bg-tick-minor" x1="12" y1="12" x2="30" y2="30"/>
          ...
          {/* Bearing reticle bottom */}
          <g transform="translate(800, 980)" opacity=".7">
            <line className="bg-tick" x1="-160" y1="0" x2="160" y2="0"/>
            <line className="bg-tick" x1="-160" y1="0" x2="-160" y2="-12"/>
            <line className="bg-tick-minor" x1="-120" y1="0" x2="-120" y2="-7"/>
            <line className="bg-tick-minor" x1="-80" y1="0" x2="-80" y2="-7"/>
            <line className="bg-tick-minor" x1="-40" y1="0" x2="-40" y2="-7"/>
            <line className="bg-tick" x1="0" y1="0" x2="0" y2="-14"/>
            <line className="bg-tick-minor" x1="40" y1="0" x2="40" y2="-7"/>
            <line className="bg-tick-minor" x1="80" y1="0" x2="80" y2="-7"/>
            <line className="bg-tick-minor" x1="120" y1="0" x2="120" y2="-7"/>
            <line className="bg-tick" x1="160" y1="0" x2="160" y2="-12"/>
            <text className="bg-label-dim" x="-160" y="-20" textAnchor="middle">N</text>
            <text className="bg-label-dim" x="0" y="-22" textAnchor="middle">E</text>
            <text className="bg-label-dim" x="160" y="-20" textAnchor="middle">S</text>
          </g>
          ...
          <g transform="translate(0, 80)">
            <line className="bg-tick-minor" x1="160" y1="0" x2="1440" y2="0"/>
            <line className="bg-tick" x1="200" y1="0" x2="200" y2="8"/>
            <line className="bg-tick-minor" x1="280" y1="0" x2="280" y2="5"/>
            <line className="bg-tick-minor" x1="360" y1="0" x2="360" y2="5"/>
            <line className="bg-tick-minor" x1="440" y1="0" x2="440" y2="5"/>
            <line className="bg-tick" x1="520" y1="0" x2="520" y2="8"/>
            <line className="bg-tick-minor" x1="600" y1="0" x2="600" y2="5"/>
            <line className="bg-tick-minor" x1="680" y1="0" x2="680" y2="5"/>
            <line className="bg-tick-minor" x1="760" y1="0" x2="760" y2="5"/>
            <line className="bg-tick" x1="840" y1="0" x2="840" y2="8"/>
            <line className="bg-tick-minor" x1="920" y1="0" x2="920" y2="5"/>
            <line className="bg-tick-minor" x1="1000" y1="0" x2="1000" y2="5"/>
            <line className="bg-tick-minor" x1="1080" y1="0" x2="1080" y2="5"/>
            <line className="bg-tick" x1="1160" y1="0" x2="1160" y2="8"/>
            <line className="bg-tick-minor" x1="1240" y1="0" x2="1240" y2="5"/>
            <line className="bg-tick-minor" x1="1320" y1="0" x2="1320" y2="5"/>
            <line className="bg-tick-minor" x1="1400" y1="0" x2="1400" y2="5"/>
            <text className="bg-label-dim" x="200" y="22" textAnchor="middle">000</text>
            <text className="bg-label-dim" x="520" y="22" textAnchor="middle">090</text>
            <text className="bg-label-dim" x="840" y="22" textAnchor="middle">180</text>
            <text className="bg-label-dim" x="1160" y="22" textAnchor="middle">270</text>
            <text className="bg-label-dim" x="1440" y="22" textAnchor="middle">360</text>
          </g>

          {/* Blinking friendly/hostile markers */}
      ...
      <div className="bento-app">
        ...
        <main className="bento-grid">
          ...
          <div className="bento-cell bento-mod">
            ...
            <div className="bento-mod-name">내전</div>
            <div className="bento-mod-desc">내전 관리 및 KD 랭킹</div>
          </div>
          ...
          <div className="bento-cell bento-mod">
            ...
            <div className="bento-mod-name">전적</div>
          ...
          <div className="bento-cell bento-mod">
            ...
            <div className="bento-mod-name">활동</div>
            <div className="bento-mod-desc">디스코드 음성 활동 자동 기록</div>
          </div>
          ...
          <div className="bento-cell bento-mod">
            ...
            <div className="bento-mod-name">일정</div>
            <div className="bento-mod-desc">일정 등록 및 관리</div>
          </div>

          <div className="bento-cell bento-mod">
            <div className="bento-cell-tag"><span>M.05</span></div>
            <div className="bento-mod-num">/notification</div>
            <div className="bento-mod-ico" aria-hidden="true">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
                <path d="M12 3 21 9 12 15 3 9Z"/><path d="M3 14 12 20 21 14"/>
              </svg>
            </div>
            <div className="bento-mod-name">공지</div>
            <div className="bento-mod-desc">서버 공지 및 발로란트 공지</div>
          </div>
            ...
            <div className="bento-join-qrs">
              <div className="bento-qr-card">
                ...
                <div className="bento-qr-info">
                  DISCORD
                  <strong>발로세끼 서버</strong>
                  <small>QR 스캔 또는 ▸ DISCORD 로그인 버튼</small>
                </div>
              </div>
              <div className="bento-qr-card">
                <div className="bento-qr-block bento-qr-real">
                ...
                <div className="bento-qr-info">
                  KAKAO · OPENCHAT
                  <strong>오픈채팅</strong>
                  <small>그룹 공지·내전 모집을 함께 볼 수 있어요</small>
                </div>
              </div>
            </div>
          </section>
